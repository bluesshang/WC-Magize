...
(function(n) {
    ...
    function yt(n) {
        if (n instanceof c)
            return n;
        if (n.touches && n.touches.length > 0 && (n = n.touches[0]),
    ...
    function wt(t, i, u) {
        ...
        if (t != null ) {
            if (f(t))
                switch (i) {
                case r.Number:
                    return o = n.Globalize.parseFloat(t, u),
                    isNaN(o) ? t : o;
                case r.Date:
                    return e = n.Globalize.parseDate(t, u),
                    e || u || !t || (e = new Date(t)),
            ...
            if (i == r.String)
                return n.Globalize.format(t, u)
        }
        return t
    }
    function bt(n, t, i) {
        var u, r;
        return i ? (r = n.toString(),
        u = r.indexOf('.'),
        u > -1 && (r = r.substr(0, u + 1 + t),
        n = parseFloat(r))) : (r = n.toFixed(t),
        n = parseFloat(r)),
        n
    }
    function kt(t, i, r) {
        return t = y(t),
        t.replace(/\{(.*?)(:(.*?))?\}/g, function(t, u, f, e) {
            var o = t;
            return u && u[0] != '{' && i && (o = i[u],
    ...
    function k(i, r) {
        ...
        if (r)
            for (u in r)
                u[0] != '_' && (t(u in i, 'Unknown property "' + u + '".'),
                f = r[u],
                i._copy && i._copy(u, f) || (i[u] instanceof n.Event && h(f) ? i[u].addHandler(f) : v(f) && i[u] && u != 'itemsSource' ? k(i[u], f) : i[u] = f))
    }
    function t(n, t) {
        if (!n)
            throw '** Assertion failed in Wijmo: ' + t;
    }
    function y(n, i) {
        return i === void 0 && (i = !0),
    ...
    function gt(n, i, r) {
        if (i === void 0 && (i = !1),
        r === void 0 && (r = !1),
        t(i && n == null  || b(n), 'Integer expected.'),
        r && n && n < 0)
    ...
    function ii(n, i, r) {
        ...
        n == null  && r)
            return null ;
        var u = i[n];
        return t(u != null , 'Invalid enum value.'),
        e(u) ? u : n
    }
    function ri(i, r) {
        if (r === void 0 && (r = !0),
        ...
        return u != null  ? u : (o(i) || t(!1, 'Array or ICollectionView expected.'),
    ...
    function oi(n, t, r) {
        if (r === void 0 && (r = t),
        n = g(n, HTMLInputElement),
        ut(document.body, n) && !n.disabled && n.style.display != 'none')
            try {
                n.focus();
    ...
    function si(n, t) {
        for (var u, f, e = n.querySelectorAll('input,select,textarea,button,a'), i = [], r = 0; r < e.length; r++)
            u = e[r],
            !u.disabled && u.tabIndex > -1 && u.clientHeight > 0 && !ft(u, '[disabled],.wj-state-disabled') && i.push(u);
        f = 0;
        t && (r = i.indexOf(document.activeElement),
        r > -1 && (f = (r + t + i.length) % i.length));
        f < i.length && i[f].focus()
    }
    function hi(n) {
    ...
    function ft(n, t) {
        ...
        if (i)
            for (; n; n = n.parentNode)
                if (n instanceof Element && i.call(n, t))
                    return n;
        return null 
    }
    function ai(n, t) {
    ...
    function vi(n) {
        ...
        return new w(t.left + pageXOffset,t.top + pageYOffset,t.width,t.height)
    }
    function yi(n, t) {
        var u = n.style, i, r;
        for (i in t)
            r = t[i],
            typeof r == 'number' && i.match(/width|height|left|top|right|bottom|size|padding|margin'/i) && (r += 'px'),
            u[i] != r && (u[i] = r.toString())
    }
    function pi(n, t, r) {
        t === void 0 && (t = 400);
        r === void 0 && (r = 35);
    ...
    function wi(n, t) {
        ...
        r = JSON.stringify(r)),
        i.onload = function() {
            i.readyState == 4 && (i.status < 300 ? t.success && s(t.success)(i) : t.error && s(t.error)(i),
            t.complete && s(t.complete)(i))
        }
        ,
        i.onerror = function() {
            if (t.error)
                ...
                throw 'HttpRequest Error: ' + i.status + ' ' + i.statusText;
        }
        ,
        i.open(l, n, p, t.user, t.password),
        t.user && t.password && i.setRequestHeader('Authorization', 'Basic ' + btoa(t.user + ':' + t.password)),
        o && i.setRequestHeader('Content-Type', 'application/json'),
        t.requestHeaders)
            for (c in t.requestHeaders)
                i.setRequestHeader(c, t.requestHeaders[c]);
        return h(t.beforeSend) && t.beforeSend(i),
        i.send(r),
        i
    }
    var st = '5.20161.151', ct, r, nt, c, et, w, ot;
    n.getVersion = ht,
    function(n) {
        n[n.Back = 8] = "Back";
        n[n.Tab = 9] = "Tab";
    ...
    w = function() {
        ...
        n.fromBoundingRect = function(i) {
            if (i.left != null )
                return new n(i.left,i.top,i.width,i.height);
            if (i.x != null )
        ...
        n.prototype.contains = function(i) {
            if (i instanceof c)
                return i.x >= this.left && i.x <= this.right && i.y >= this.top && i.y <= this.bottom;
            if (i instanceof n) {
                var r = i;
    ...
    ot = function() {
        ...
        t.fromDateTime = function(n, t) {
            return !n && !t ? null  : (n || (n = t),
            t || (t = n),
            new Date(n.getFullYear(),n.getMonth(),n.getDate(),t.getHours(),t.getMinutes(),t.getSeconds()))
        }
        ,
...
function(n) {
    ...
    var t = function() {
        ...
        return t.format = function(i, r, u, f) {
            return n.isString(i) ? i : n.isNumber(i) ? (r = r || (i == Math.round(i) ? 'n0' : 'n2'),
            t.formatNumber(i, r, u, f)) : n.isDate(i) ? (r = r || 'd',
            t.formatDate(i, r)) : i != null  ? i.toString() : ''
        }
        ,
        t.formatNumber = function(t, i, r, u) {
            ...
            n.asNumber(t);
            n.asString(i);
            var f, o = i ? i.match(/([a-z])(\d*)(,*)(.*)/i) : null , s = n.culture.Globalize.numberFormat, e = o ? o[1].toLowerCase() : 'n', h = o && o[2] ? parseInt(o[2]) : e == 'c' ? s.currency.decimals : t == Math.round(t) ? 0 : 2, p = o && o[3] ? 3 * o[3].length : 0, w = o && o[4] ? o[4] : s.currency.symbol, a = s['.'], v = s[','];
            if (p && (t /= Math.pow(10, p)),
            e == 'd' || e == 'x') {
                for (f = Math.round(Math.abs(t)).toString(e == 'd' ? 10 : 16); f.length < h; )
                    f = '0' + f;
                return t < 0 && (f = '-' + f),
                i && i[0] == 'X' && (f = f.toUpperCase()),
                f
            }
            return e == 'p' && (t = n.toFixed(t * 100, h, !1)),
            u && (t = n.toFixed(t, h, !0)),
            f = e == 'c' || e == 'p' ? Math.abs(t).toFixed(h) : t.toFixed(h),
            (r || e == 'g') && f.indexOf('.') > -1 && (f = f.replace(/(\.[0-9]*?)0+$/g, '$1'),
            f = f.replace(/\.$/, '')),
            a != '.' && (f = f.replace('.', a)),
            v && (e == 'n' || e == 'c' || e == 'p') && (c = f.indexOf(a),
            y = /\B(?=(\d\d\d)+(?!\d))/g,
            f = c > -1 ? f.substr(0, c).replace(y, v) + f.substr(c) : f.replace(y, v)),
            e == 'c' && (l = s.currency.pattern[t < 0 ? 0 : 1],
            f = l.replace('n', f).replace('$', w)),
            e == 'p' && (l = s.percent.pattern[t < 0 ? 0 : 1],
            f = l.replace('n', f)),
            f
        }
        ,
        t.formatDate = function(i, r) {
            ...
            for (r = t._expandFormat(r),
            f = t._parseDateFormat(r),
            e = '',
            u = 0; u < f.length; u++)
        ...
        t.parseDate = function(i, r) {
            ...
            if (r == 'u')
                return new Date(i);
            if (r == 'R' || r == 'r')
                return ut = /(([0-9]+)\-([0-9]+)\-([0-9]+))?\s?(([0-9]+):([0-9]+)(:([0-9]+))?)?/,
                s = i.match(ut),
                s[1] || s[5] ? (e = s[1] ? new Date(parseInt(s[2]),parseInt(s[3]) - 1,parseInt(s[4])) : new Date,
                s[5] && (e.setHours(parseInt(s[6])),
                e.setMinutes(parseInt(s[7])),
                e.setSeconds(s[8] ? parseInt(s[9]) : 0))) : e = new Date(i),
                isNaN(e.getTime()) ? null  : e;
            r = t._expandFormat(r ? r : 'd');
            var h = n.culture.Globalize.calendar, ft = t._CJK, ct = new RegExp('(\\' + h['/'] + ')|(\\' + h[':'] + ")|(\\d+)|([" + ft + "\\.]{2,})|([" + ft + ']+)','gi'), c = i.match(ct), w = t._parseDateFormat(r), y = 0, l = -1, a = 0, d = 1, o = 0, b = 0, k = 0, et = 0, tt = -1, ot, it, st, g, rt;
            if (!c || !c.length || !w || !w.length)
                return null ;
            ...
            isNaN(b) && (b = 0),
            isNaN(k) && (k = 0)),
            a < 0 || a > 11 || isNaN(a) || d < 0 || d > 31 || isNaN(d) || o < 0 || o > 24 || isNaN(o) || b < 0 || b > 60 || isNaN(b) || k < 0 || k > 60 || isNaN(k))
                return null ;
            if (rt) {
                if (!g)
                    return null ;
            ...
            return ot && !it ? null  : st && !g ? null  : (l < 0 && (l = (new Date).getFullYear()),
            tt > -1 ? l = l + h.eras[tt].start.getFullYear() - 1 : l < 100 && (l += l >= 30 ? 1900 : 2e3),
            e = new Date(l,a,d,o,b + 0,k,et),
            isNaN(e.getTime()) ? null  : e)
        }
        ,
        ...
        t._parseDateFormat = function(n) {
            var u, e, i, r, f;
            if (n in t._dateFomatParts)
                return t._dateFomatParts[n];
            for (u = [],
            e = '',
            i = 0; i > -1 && i < n.length; i++) {
                if (f = n[i],
                (f == '\'' || f == '"') && (r = n.indexOf(f, i + 1),
                r > -1)) {
            ...
            return t._dateFomatParts[n] = u,
            u
        }
        ,
        t._formatDatePart = function(i, r, u) {
            var f = n.culture.Globalize.calendar, o = 0, h = 0, l = 0, c, e = u.length, s;
            switch (u) {
            case 'yyyy':
            case 'yyy':
            case 'yy':
            ...
            case 'ee':
            case 'e':
                return c = u[0] == 'E' ? n.DateTime.toFiscal(i, !0) : u[0] == 'e' ? n.DateTime.toFiscal(i, !1) : i,
                h = c.getFullYear(),
                f.eras.length > 1 && r.indexOf('g') > -1 && (o = t._getEra(i, f),
                o > -1 && (h = h - f.eras[o].start.getFullYear() + 1)),
                t._zeroPad(h, 4).substr(4 - u.length);
            case 'MMMM':
            ...
            case 'f':
            case 'F':
                return l = i.getMilliseconds() * Math.pow(10, e - 3),
                u[0] == 'f' ? t._zeroPad(l, e) : l.toFixed(0);
            case 'tt':
            ...
            case 'u':
            case 'U':
                return c = n.DateTime.toFiscal(i, u == 'U'),
                (Math.floor(c.getMonth() / 3) + 1).toString();
            case 'ggg':
            case 'gg':
            case 'g':
                return f.eras.length > 1 && (o = t._getEra(i, f),
                o > -1) ? u == 'ggg' ? f.eras[o].name : u == 'gg' ? f.eras[o].name[0] : f.eras[o].symbol : f.eras[0];
            case ':':
            case '/':
                return f[u];
            case 'K':
                return s = i.toString().match(/(\+|\-)(\d{2})(\d{2})/),
                s ? s[1] + s[2] + s[3] : ''
            }
        ...
        t._getEra = function(t, i) {
            ...
            if (n.isDate(t)) {
                ...
                for (r = 0; r < i.eras.length; r++)
                    if (i.eras[r].name && (i.eras[r].name.indexOf(t) == 0 || i.eras[r].symbol.indexOf(t) == 0))
                        return r;
            return -1
        }
        ,
        ...
        t._h12 = function(t) {
            var r = n.culture.Globalize.calendar
              , i = t.getHours();
            return r.am && r.am[0] && (i = i % 12,
            i == 0 && (i = 12)),
            i
        }
        ,
        t._CJK = 'a-zu00C0-u017Fu3000-u30ffu4e00-u9faf'.replace(/u/g, '\\u'),
        t._dateFomatParts = {},
        t
    }();
    n.Globalize = t
    ...
    var t = function() {
        ...
        return Object.defineProperty(n.prototype, "path", {
            ...
            set: function(n) {
                var t, i, r;
                for (this._path = n,
                this._parts = n ? n.split('.') : [],
                t = 0; t < this._parts.length; t++)
                    i = this._parts[t],
                    r = i.indexOf('['),
                    r > -1 && (this._parts[t] = i.substr(0, r),
...
function(n) {
    ...
    var f = function() {
        ...
        i.prototype.removeHandler = function(t, i) {
            var r, u;
            for (n.asFunction(t),
            r = 0; r < this._handlers.length; r++)
                if (u = this._handlers[r],
                (u.handler == t || t == null ) && (u.self == i || i == null ) && (this._handlers.splice(r, 1),
                t && i))
                    break
        }
        ,
        ...
        i.prototype.raise = function(n, i) {
            var r, u;
            for (i === void 0 && (i = t.empty),
            r = 0; r < this._handlers.length; r++)
                u = this._handlers[r],
                u.handler.call(u.self, n, i)
        }
        ,
...
function(n) {
    ...
    var t = function() {
        function t(i, r, u) {
            ...
            n.assert(t.getControl(i) == null , 'Element is already hosting a control.'),
            f = n.getElement(i),
            ...
            this._e = f,
            f[t._DATA_KEY] = this,
            u == !0 && (this._szCtl = new n.Size(f.offsetWidth,f.offsetHeight),
            ...
            this.addEventListener(f, 'blur', function() {
                setTimeout(function() {
                    c.containsFocus() || c._updateFocusState()
                })
            }, !0),
            ...
            this.addEventListener(f, 'onmousewheel' in document ? 'mousewheel' : 'DOMMouseScroll', s, !0),
            t._touching == null  && (t._touching = !1,
            'ontouchstart' in window || 'onpointerdown' in window)) {
                var e = document.body
                  , a = this._handleTouchStart
                  , h = this._handleTouchEnd;
                'ontouchstart' in window ? (e.addEventListener('touchstart', a),
                e.addEventListener('touchend', h),
                e.addEventListener('touchcancel', h),
                e.addEventListener('touchleave', h)) : 'onpointerdown' in window && (e.addEventListener('pointerdown', a),
        ...
        return t.prototype.getTemplate = function() {
            for (var t, n = Object.getPrototypeOf(this); n; n = Object.getPrototypeOf(n))
                if (t = n.constructor.controlTemplate,
                t)
                    return t;
            return null 
        }
        ...
        t.prototype.applyTemplate = function(t, i, r, u) {
            var f = this._e, s, e, h, o;
            if (t && n.addClass(f, t),
            s = null ,
            i && (s = n.createElement(i, f)),
            f && !f.getAttribute('tabindex') && (f.tabIndex = f.querySelector('input') ? -1 : 0),
            r)
                for (e in r) {
                    if (h = r[e],
                    this[e] = s.querySelector('[wj-part="' + h + '"]'),
                    this[e] == null  && s.getAttribute('wj-part') == h && (this[e] = s),
                    this[e] == null )
                        throw 'Missing template part: "' + h + '"';
                    h == u && (o = f.attributes.name,
                    o && o.value && this[e].setAttribute('name', o.value),
                    o = f.attributes.accesskey,
                    o && o.value && (this[e].setAttribute('accesskey', o.value),
        ...
        t.prototype.dispose = function() {
            for (var e, u, i, r, o = this._e.querySelectorAll('.wj-control'), f = 0; f < o.length; f++)
                e = t.getControl(o[f]),
                e && e.dispose();
            this._toInv && clearTimeout(this._toInv);
            this.removeEventListener();
            for (i in this)
                i.length > 2 && i.indexOf('on') == 0 && (r = this[i[2].toLowerCase() + i.substr(3)],
                r instanceof n.Event && r.removeAllHandlers());
            if (u = this.collectionView,
            u instanceof n.collections.CollectionView)
                for (i in u)
                    r = u[i],
                    r instanceof n.Event && r.removeHandler(null , this);
        ...
        t.prototype.containsFocus = function() {
            ...
            if (!this._e)
                return !1;
            for (f = this._e.getElementsByClassName('wj-control'),
            i = 0; i < f.length; i++)
                if (r = t.getControl(f[i]),
                r && r != this && r.containsFocus())
                    return !0;
            return (e = document.activeElement,
            u = t.getControl(n.closest(e, '.wj-control.wj-popup')),
            u && u.owner && n.contains(this._e, u.owner)) ? !0 : n.contains(this._e, e)
        }
        ,
        ...
        t.prototype.refresh = function(n) {
            n === void 0 && (n = !0);
            !this.isUpdating && this._toInv && (clearTimeout(this._toInv),
            this._toInv = null ,
            this._fullUpdate = !1)
        }
        ,
        ...
        t.refreshAll = function(n) {
            ...
            n.children)
                for (i = 0; i < n.children.length; i++)
                    t.refreshAll(n.children[i])
        }
        ,
        t.disposeAll = function(n) {
            var r = t.getControl(n), i;
            if (r)
                r.dispose();
            else if (n.children)
                for (i = 0; i < n.children.length; i++)
                    t.disposeAll(n.children[i])
        }
        ,
        ...
        t.prototype.removeEventListener = function(n, t, i) {
            var f = 0, u, r;
            if (this._listeners)
                for (u = 0; u < this._listeners.length; u++)
                    r = this._listeners[u],
                    (n == null  || n == r.target) && (t == null  || t == r.type) && (i == null  || i == r.capture) && (r.target.removeEventListener(r.type, r.fn, r.capture),
        ...
        t.prototype._handleResize = function() {
            if (this._e.parentElement) {
                ...
                t.equals(this._szCtl) || (this._szCtl = t,
                this.invalidate())
            }
        }
        ,
        t.prototype._updateFocusState = function() {
            var i = this;
            setTimeout(function() {
                for (var r, f, u = i._e; u; u = u.parentElement)
                    r = t.getControl(u),
                    r && (f = r.containsFocus(),
                    f != r._focus && (r._focus = f,
                    f ? r.onGotFocus() : r.onLostFocus(),
                    n.toggleClass(u, 'wj-state-focused', f)))
            })
        }
        ,
        ...
        t.prototype._handleDisabled = function(n) {
            this.disabled && (n.preventDefault(),
            n.stopPropagation(),
            n.stopImmediatePropagation())
        }
        ,
        t.prototype._replaceWithDiv = function(n) {
            var f = n.parentElement, i = document.createElement('div'), r, t, u;
            for (f.replaceChild(i, n),
            i.innerHTML = n.innerHTML,
            r = n.attributes,
            t = 0; t < r.length; t++)
                u = r[t].name,
                (u == 'id' || u == 'style') && i.setAttribute(u, r[t].value);
            return i
        }
        ,
        t.prototype._copyOriginalAttributes = function(n) {
            var r = this._orgAtts, t, i;
            if (r)
                for (t = 0; t < r.length; t++)
                    i = r[t].name.toLowerCase(),
                    i != 'id' && i != 'style' && i != 'type' && n.setAttribute(i, r[t].value)
        }
        ,
        t._DATA_KEY = 'wj-Control',
...
function(n) {
    'use strict';
    function i(i, r, u) {
        for (var e, o, v = 0, f = 0, l = 0, s = 0, h = null , c = null , y = u ? new n.Binding(u) : null , a = 0; a < r.length; a++)
            e = r[a],
            y && (e = y.getValue(e)),
            e != null  && (v++,
            (h == null  || e < h) && (h = e),
            (c == null  || e > c) && (c = e),
            n.isNumber(e) && !isNaN(e) ? (f++,
            l += e,
            s += e * e) : n.isBoolean(e) && (f++,
            e == !0 && (l++,
            s++)));
        o = f == 0 ? 0 : l / f;
        switch (i) {
        ...
        r = function(i) {
            ...
            r.prototype.push = function() {
                ...
                r = 0; n && r < n.length; r++)
                    ...
                    this._updating || this._raiseCollectionChanged(t.NotifyCollectionChangedAction.Add, n[r], f - 1);
                return f
            }
            ,
            r.prototype.pop = function() {
                var n = i.prototype.pop.call(this);
                return this._raiseCollectionChanged(t.NotifyCollectionChangedAction.Remove, n, this.length),
                n
            }
            ,
            r.prototype.splice = function(n, r, u) {
                var f;
                return r && u ? (f = i.prototype.splice.call(this, n, r, u),
                r == 1 ? this._raiseCollectionChanged(t.NotifyCollectionChangedAction.Change, u, n) : this._raiseCollectionChanged(),
                f) : u ? (f = i.prototype.splice.call(this, n, 0, u),
                this._raiseCollectionChanged(t.NotifyCollectionChangedAction.Add, u, n),
                f) : (f = i.prototype.splice.call(this, n, r),
                r == 1 ? this._raiseCollectionChanged(t.NotifyCollectionChangedAction.Remove, f[0], n) : this._raiseCollectionChanged(),
                f)
            }
            ,
            ...
            r.prototype.sort = function(n) {
                ...
                return this._raiseCollectionChanged(),
                t
            }
            ,
            ...
            r.prototype.endUpdate = function() {
                this._updating > 0 && (this._updating--,
            ...
            r.prototype._raiseCollectionChanged = function(n, i, r) {
                if (n === void 0 && (n = t.NotifyCollectionChangedAction.Reset),
                !this.isUpdating) {
        ...
        var r = function() {
            function r(i) {
                ...
                this._srtDsc.collectionChanged.addHandler(function() {
                    for (var u = r._srtDsc, i = 0; i < u.length; i++)
                        n.assert(u[i] instanceof t.SortDescription, 'sortDescriptions array must contain SortDescription objects.');
                    r.canSort && r.refresh()
                });
                this._grpDesc.collectionChanged.addHandler(function() {
                    for (var u = r._grpDesc, i = 0; i < u.length; i++)
                        n.assert(u[i] instanceof t.GroupDescription, 'groupDescriptions array must contain GroupDescription objects.');
            ...
            r.prototype.onSourceCollectionChanging = function(n) {
                return this.sourceCollectionChanging.raise(this, n),
                !n.cancel
            }
            ,
            r.prototype.onSourceCollectionChanged = function() {
            ...
            Object.defineProperty(r.prototype, "filter", {
                ...
                set: function(t) {
                    this._filter != t && (this._filter = n.asFunction(t),
            ...
            r.prototype.moveCurrentToPosition = function(t) {
                if (t >= -1 && t < this._pgView.length) {
                    ...
                    this._idx != t && this.onCurrentChanging(i) && (this._edtItem && this._pgView[t] != this._edtItem && this.commitEdit(),
                    this._newItem && this._pgView[t] != this._newItem && this.commitNew(),
                    this._idx = t,
            ...
            r.prototype.refresh = function() {
                this._updating > 0 || this._newItem || this._edtItem || (this._performRefresh(),
                this.onCollectionChanged())
            }
            ,
            r.prototype._performRefresh = function() {
                var i = this.currentItem, t;
                ...
                this.canSort && this._srtDsc.length > 0 && this._performSort(this._view);
                ...
                this._groups && this.pageCount > 1 && (this._groups = this._createGroups(this._pgView),
            ...
            r.prototype._compareItems = function() {
                ...
                return function(r, u) {
                    for (var c, l, h, s = 0; s < t.length; s++) {
                        ...
                        if (f !== f && (f = null ),
                        e !== e && (e = null ),
                        typeof f == 'string' && typeof e == 'string' && (c = f.toLowerCase(),
                        l = e.toLowerCase(),
                        c != l && (f = c,
                        e = l)),
                        n && (f = n(o, r, f, i),
            ...
            r.prototype.onCurrentChanging = function(n) {
                return this.currentChanging.raise(this, n),
                !n.cancel
            }
            ,
            ...
            r.prototype.addNew = function() {
                var i, u, r;
                if (arguments.length > 0 && n.assert(!1, 'addNew does not take any parameters, it creates the new items.'),
                this.commitEdit(),
                this.commitNew(),
                !this.canAddNew)
                    return n.assert(!1, 'cannot add items (canAddNew == false).'),
                    null ;
                if (i = null ,
                u = this.sourceCollection,
                i = this.newItemCreator ? this.newItemCreator() : u && u.length ? new u[0].constructor : {},
                i != null ) {
                    if (this._newItem = i,
                    this._updating++,
                    this._src.push(i),
                    ...
                    this.groups && this.groups.length)
                        for (r = this.groups[this.groups.length - 1],
                        r.items.push(i); r.groups && r.groups.length; )
                            r = r.groups[r.groups.length - 1],
                            r.items.push(i);
            ...
            r.prototype.cancelEdit = function() {
                var r = this._edtItem, i;
                if (r != null ) {
                    if (this._edtItem = null ,
                    !this.canCancelEdit) {
                        n.assert(!1, 'cannot cancel edits (canCancelEdit == false).');
                        return
                    }
                    if (i = this._src.indexOf(r),
                    i < 0 || !this._edtClone)
                        return;
            ...
            r.prototype.commitEdit = function() {
                var n = this._edtItem, r, i, u;
                n != null  && (this._committing = !0,
                ...
                this._pgView.indexOf(n) == i && u == this._digest ? this._raiseCollectionChanged(t.NotifyCollectionChangedAction.Change, n, i) : this._raiseCollectionChanged(),
                this._committing = !1)
            }
            ,
            r.prototype.commitNew = function() {
                var n = this._newItem, i, u, r;
                n != null  && (this._newItem = null ,
                i = this._pgView.indexOf(n),
                u = this._digest,
                this._performRefresh(),
                this._trackChanges == !0 && (r = this._chgEdited.indexOf(n),
            ...
            r.prototype.editItem = function(n) {
                n != this._edtItem && this.moveCurrentTo(n) && (this.commitEdit(),
                this._edtItem = n,
                this._edtClone = {},
            ...
            r.prototype.remove = function(i) {
                var e = i == this._newItem, r, o, s, u, f, h, c, l;
                if (e && (this._newItem = null ),
                ...
                r > -1 && (o = this.currentItem,
                this._updating++,
                this._src.splice(r, 1),
                this._updating--,
                s = this._digest,
                this._performRefresh(),
                this._trackChanges == !0 && (u = this._chgAdded.indexOf(i),
                ...
                c || l || s != this._getGroupsDigest(this.groups) ? this._raiseCollectionChanged() : this._raiseCollectionChanged(t.NotifyCollectionChangedAction.Remove, i, r),
            ...
            r.prototype._trackItemChanged = function(n) {
                ...
                if (this._trackChanges)
                    if (i = this._chgEdited.indexOf(n),
                    ...
                    } else if (i = this._chgAdded.indexOf(n),
                    i > -1) {
                        r = new t.NotifyCollectionChangedEventArgs(t.NotifyCollectionChangedAction.Change,n,i);
            ...
            Object.defineProperty(r.prototype, "pageSize", {
                ...
                set: function(t) {
                    t != this._pgSz && (this._pgSz = n.asInt(t),
                    this.refresh())
                },
                enumerable: !0,
                configurable: !0
            ...
            r.prototype.moveToPage = function(i) {
                var r = n.clamp(i, 0, this.pageCount - 1), u;
                return r != this._pgIdx && (this.canChangePage || n.assert(!1, 'cannot change pages (canChangePage == false).'),
                u = new t.PageChangingEventArgs(r),
                this.onPageChanging(u) && (this._pgIdx = r,
                this._pgView = this._getPageView(),
                this._idx = 0,
                this.groupDescriptions && this.groupDescriptions.length != 0 ? this.refresh() : (this.onPageChanged(),
                this.onCollectionChanged()))),
                this._pgIdx == i
            }
            ,
            ...
            r.prototype.onPageChanging = function(n) {
                return this.pageChanging.raise(this, n),
                !n.cancel
            }
            ,
            ...
            r.prototype._getGroupByPath = function(n, t, i) {
                for (var r, u = 0; u < n.length; u++)
                    if ((r = n[u],
                    r.level == t && r._path == i) || r.level < t && i.indexOf(r._path) == 0 && (r = this._getGroupByPath(r.groups, t, i),
                    r != null ))
                        return r;
                return null 
            }
            ...
            r.prototype._getGroupsDigest = function(n) {
                for (var t, i = '', r = 0; n != null  && r < n.length; r++)
                    ...
                    t.groups.length > 0 && (i += ',',
                    i += this._getGroupsDigest(t.groups)),
                    i += '}';
                return i
            }
            ,
            r.prototype._mergeGroupItems = function(n) {
                for (var i, f, t, r, e = [], u = 0; u < n.length; u++) {
                    if (i = n[u],
                    !i._isBottomLevel)
                        for (f = this._mergeGroupItems(i.groups),
                        t = 0,
                        r = f.length; t < r; t++)
                            i._items.push(f[t]);
                    for (t = 0,
                    r = i._items.length; t < r; t++)
                        e.push(i._items[t])
                }
                return e
            }
            ...
            r.prototype._getGroup = function(t, r, u, f, e, o) {
                ...
                if (u && n.isPrimitive(f)) {
                    ...
                    for (s = 0; s < r.length; s++)
                        if (t.namesMatch(r[s].name, f))
                            return r[s];
                return h = new i(t,f,e,o),
                r.push(h),
                u && (u[f] = h),
                h
            }
...
function(n) {
    ...
    var i = function() {
        ...
        i.prototype.show = function(r, u, f) {
            ...
            e = i._eTip;
            e || (e = i._eTip = document.createElement('div'),
            ...
            o = new t(u);
            this.onPopup(o);
            o.content && !o.cancel && (this._setContent(o.content),
            e.style.minWidth = '',
            f = new n.Rect(f.left - (e.offsetWidth - f.width) / 2,f.top - this.gap,e.offsetWidth,f.height + 2 * this.gap),
            n.showPopup(e, f, !0),
            document.addEventListener('mousedown', this._hideAutoTipBnd))
        }
        ,
        i.prototype.hide = function() {
            i._eTip && (i._eTip.style.visibility = 'hidden',
            i._eTip.innerHTML = '');
        ...
        i.prototype._showAutoTip = function(t) {
            ...
            this._toShow = setTimeout(function() {
                var u = i._indexOf(t.target), r, f;
                u > -1 && (r = i._tips[u],
                f = i._showAtMouse ? new n.Rect(t.clientX,t.clientY,0,0) : null ,
                i.show(r.element, r.content, f),
                i._hideDelay > 0 && (i._toHide = setTimeout(function() {
                    i.hide()
                }, i._hideDelay)))
            }, r)
        }
        ...
        i.prototype._clearTimeouts = function() {
            this._toShow && (clearTimeout(this._toShow),
            this._toShow = null );
            this._toHide && (clearTimeout(this._toHide),
            this._toHide = null )
        }
        ,
...
function(n) {
    ...
    var t = function() {
        ...
        t.fromRgba = function(i, r, u, f) {
            f === void 0 && (f = 1);
            var e = new t(null );
            return e.r = Math.round(n.clamp(n.asNumber(i), 0, 255)),
        ...
        t.toOpaque = function(i, r) {
            if (i = n.isString(i) ? t.fromString(i) : n.asType(i, t),
            i.a == 1)
                return i;
        ...
        t.prototype._parse = function(n) {
            ...
            if (n = n.toLowerCase(),
            n == 'transparent')
                return this._r = this._g = this._b = this._a = 0,
                !0;
            if (n && n.indexOf('#') != 0 && n.indexOf('rgb') != 0 && n.indexOf('hsl') != 0 && (u = document.createElement('div'),
            u.style.color = n,
            f = u.style.color,
            f == n && (f = window.getComputedStyle(u).color,
            f || (document.body.appendChild(u),
            f = window.getComputedStyle(u).color,
            document.body.removeChild(u))),
            n = f.toLowerCase()),
            n.indexOf('#') == 0)
                return n.length == 4 ? (this.r = parseInt(n[1] + n[1], 16),
                this.g = parseInt(n[2] + n[2], 16),
                this.b = parseInt(n[3] + n[3], 16),
                this.a = 1,
                !0) : n.length == 7 ? (this.r = parseInt(n.substr(1, 2), 16),
                this.g = parseInt(n.substr(3, 2), 16),
                this.b = parseInt(n.substr(5, 2), 16),
                this.a = 1,
                !0) : !1;
            if (n.indexOf('rgb') == 0 && (r = n.indexOf('('),
            e = n.indexOf(')'),
            r > -1 && e > -1 && (i = n.substr(r + 1, e - (r + 1)).split(','),
            i.length > 2)))
                return this.r = parseInt(i[0]),
                this.g = parseInt(i[1]),
                this.b = parseInt(i[2]),
                this.a = i.length > 3 ? parseFloat(i[3]) : 1,
                !0;
            if (n.indexOf('hsl') == 0 && (r = n.indexOf('('),
            e = n.indexOf(')'),
            r > -1 && e > -1 && (i = n.substr(r + 1, e - (r + 1)).split(','),
            i.length > 2))) {
        ...
        t._hslToRgb = function(i, r, u) {
            var o, s, h, f, e;
            return n.assert(i >= 0 && i <= 1 && r >= 0 && r <= 1 && u >= 0 && u <= 1, 'bad HSL values'),
            r == 0 ? o = s = h = u : (f = u < .5 ? u * (1 + r) : u + r - u * r,
            e = 2 * u - f,
        ...
        t._rgbToHsl = function(t, i, r) {
            ...
            i /= 255;
            r /= 255;
            var u = Math.max(t, i, r), o = Math.min(t, i, r), f, s, h = (u + o) / 2;
            if (u == o)
                f = s = 0;
            else {
                e = u - o;
        ...
        t._hsbToHsl = function(t, i, r) {
            ...
            return n.assert(!isNaN(u) && !isNaN(e), 'bad conversion to HSL'),
            [t, e, u]
        }
        ,
        t._hslToHsb = function(t, i, r) {
            ...
            return n.assert(!isNaN(u) && !isNaN(f), 'bad conversion to HSB'),
            [t, f, u]
        }
        ,
        t
    ...
    var t = function() {
        ...
        n._copyPasteInternal = function(n) {
            for (var r = document.activeElement, i = r, t; i; i = i.parentElement)
                if (i == document.body || i.getAttribute('aria-describedby') == 'dialog')
                    break;
...
function(n) {
    ...
    function i(i, r, u, f, e) {
        ...
        r instanceof HTMLElement) {
            if (!n.contains(document.body, r))
                return;
            for (a = r.parentElement; a; a = a.parentElement)
        ...
        v.appendChild(i);
        r instanceof HTMLElement && e && (c = getComputedStyle(r),
        nt = new n.Color(c.backgroundColor),
        nt.a && n.setCss(i, {
            color: c.color,
        ...
        var y = getComputedStyle(i)
          ...
          , l = new n.Size(i.offsetWidth + rt,i.offsetHeight + it)
          , s = new n.Point
          , o = null ;
        if (r && r.clientX != null  && r.clientY != null  && r.pageX != null  && r.pageY != null )
            r.clientX <= 0 && r.clientY <= 0 && r.target ? o = r.target.getBoundingClientRect() : (s.x = Math.max(0, r.pageX - pageXOffset),
            s.y = Math.max(0, r.pageY - pageYOffset));
        else if (r instanceof n.Point)
            s = r;
        else if (r instanceof HTMLElement)
            o = r.getBoundingClientRect();
        else if (r && r.top != null  && r.left != null )
            o = r;
        else if (r == null )
            s.x = Math.max(0, (innerWidth - l.width) / 2),
            s.y = Math.max(0, Math.round((innerHeight - l.height) / 2 * .7));
        else
            throw 'Invalid ref parameter.';
        if (p = parseFloat(y.minWidth),
        o) {
            var b = o.top
              , k = innerHeight - o.bottom
              , ut = getComputedStyle(i).direction == 'rtl';
            s.x = ut ? Math.max(0, o.right - l.width) : Math.max(0, Math.min(o.left, innerWidth - l.width));
            s.y = u ? b > l.height || b > k ? Math.max(0, o.top - l.height) : o.bottom : k > l.height || k > b ? o.bottom : Math.max(0, o.top - l.height);
            p = Math.max(p, o.width)
        }
        if (d = r == null  ? new n.Rect(0,0,0,0) : v == document.body ? new n.Rect(-pageXOffset,-pageYOffset,0,0) : v.getBoundingClientRect(),
        tt = {
        ...
        n.setCss(i, tt),
        g = r instanceof MouseEvent ? r.target : r,
        g instanceof HTMLElement)
            for (h = g.parentElement; h && h != document.body; h = h.parentElement)
                getComputedStyle(h).overflowY == 'auto' && h.scrollHeight > h.offsetHeight && (w || (w = new n.Control(document.createElement('div'))),
                w.addEventListener(h, 'scroll', function() {
                    t(i, !0);
                    w.dispose()
                }))
    }
...
function(n) {
    ...
    var t = function() {
        ...
        t.prototype._close = function() {
            var i = this._getDocument(), r, e, u, o, t, s, f;
            if (i.close(),
            this.title && (r = i.querySelector('title'),
            r || (r = i.createElement('title'),
            i.head.appendChild(r)),
            r.textContent = this.title),
            this._copyCss) {
                for (e = document.head.querySelectorAll('LINK'),
                t = 0; t < e.length; t++)
                    u = e[t],
                    u.href.match(/\.css$/i) && u.rel.match(/stylesheet/i) && (f = n.httpRequest(u.href, {
                        async: !1
                    }),
                    this._addStyle(f.responseText));
                for (o = document.head.querySelectorAll('STYLE'),
                t = 0; t < o.length; t++)
...
function(n) {
    ...
    var i = function() {
        ...
        Object.defineProperty(i.prototype, "mask", {
            ...
            set: function(t) {
                t != this._msk && (this._msk = n.asString(t, !0),
                this._parseMask(),
                this._valueChanged())
            },
            enumerable: !0,
        ...
        Object.defineProperty(i.prototype, "promptChar", {
            ...
            set: function(t) {
                t != this._promptChar && (this._promptChar = n.asString(t, !1),
                n.assert(this._promptChar.length == 1, 'promptChar must be a string with length 1.'),
                this._valueChanged())
            },
            enumerable: !0,
            configurable: !0
        ...
        i.prototype._preventKey = function(t) {
            ...
            if (t && this._mskArr.length) {
                ...
                if (i < this._firstPos && (i = this._firstPos,
                n.setSelectionRange(u, i)),
                i >= this._mskArr.length)
                    return !0;
                if (r = this._mskArr[i],
                r.literal)
                    this._validatePosition(i);
        ...
        i.prototype._connect = function(n) {
            var t = this._tbx;
            t && (n ? (this._autoComplete = t.autocomplete,
            ...
            t.addEventListener('compositionstart', this._hbCompositionStart, !0),
            t.addEventListener('compositionend', this._hbCompositionEnd, !0),
            this._valueChanged()) : (t.autocomplete = this._autoComplete,
            ...
            t.removeEventListener('compositionstart', this._hbCompositionStart, !0),
            t.removeEventListener('compositionend', this._hbCompositionEnd, !0)))
        }
        ,
        i.prototype._valueChanged = function() {
            var t = this._tbx, n, i, r;
            t && (n = t.selectionStart,
            i = n > 0 ? t.value[n - 1] : '',
            t.value = this._applyMask(),
            r = n > 0 ? t.value[n - 1] : '',
            n > 0 && r == this._promptChar && i != this.promptChar && n--,
            this._validatePosition(n))
        }
        ,
        i.prototype._applyMask = function() {
            var t = this._tbx.value, e = '', u = 0, f, r, n, i;
            if (this._full = !0,
            !this.mask)
                return t;
            for (t = this._handleVagueLiterals(t),
            f = 0; f < this._mskArr.length; f++) {
                if (r = this._mskArr[f],
                n = r.literal,
                n && n == t[u] && u++,
                r.wildCard) {
                    if (n = this._promptChar,
                    t) {
        ...
        i.prototype._handleVagueLiterals = function(n) {
            var i, t, f, r, e, u;
            if (n.length > this._mskArr.length + 1)
                return n;
            if (i = n.length - this._mskArr.length,
            i != 0 && n.length > 1) {
                for (t = -1,
                f = Math.max(0, this._tbx.selectionStart - i),
                r = f; r < this._mskArr.length; r++)
                ...
                if (t > -1)
                    if (i < 0)
                        ...
                        while (t > 0 && this._mskArr[t - 1].literal)
                            t--;
        ...
        i.prototype._validatePosition = function(t) {
            var i = this._mskArr;
            if (this._backSpace)
                while (t > 0 && t < i.length && i[t - 1].literal)
                    t--;
            if (t == 0 || !this._backSpace)
                while (t < i.length && i[t].literal)
                    t++;
        ...
        ,
        i._X_DBCS_BIG_HIRA = '\u3041\u3043\u3045\u3047\u3049\u3063\u3083\u3085\u3087\u308e\u3095\u3096',
        i._X_DBCS_BIG_KATA = '\u30a1\u30a3\u30a5\u30a7\u30a9\u30c3\u30e3\u30e5\u30e7\u30ee\u30f5\u30f6',
        i._X_SBCS_BIG_KATA = '\uff67\uff68\uff69\uff6a\uff6b\uff6c\uff6d\uff6e\uff6f',
        i
    }(), t;
    n._MaskProvider = i;
    t = function() {
        function n(n, t) {
            t ? (this.wildCard = n,
            this.charCase = t) : this.literal = n
        }
        return n
    }();
    n._MaskElement = t
...
function(n) {
    ...
    var r = navigator.userAgent.match(/MSIE |Trident\/|Edge\//) != null , i, t;
    n.isIE = u;
    n.isIE9 = f;
    document.doctype && navigator.appVersion.indexOf('MSIE 9') > -1 && (i = !0,
    document.addEventListener('mousemove', function(n) {
        if (n.which == 1)
            for (var t = n.target; t; t = t.parentNode)
                if (t.attributes && t.attributes.draggable)
                    return t.dragDrop(),
                    !1
    }));
    window.requestAnimationFrame || (t = 0,
