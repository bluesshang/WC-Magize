        ...
        var i = t.HeadersVisibility
          , r = function (r) {
              ...
              Object.defineProperty(u.prototype, "sortRowIndex", {
                  ...
                  set: function (t) {
                      t != this._sortRowIndex && (this._sortRowIndex = n.asNumber(t, !0),
                      this.invalidate())
                  },
                  enumerable: !0,
                  configurable: !0
              ...
              Object.defineProperty(u.prototype, "cellFactory", {
                  ...
                  set: function (i) {
                      i != this._cf && (this._cf = n.asType(i, t.CellFactory, !1),
                      this.invalidate())
                  },
                  enumerable: !0,
                  configurable: !0
                  ...
                  r = i.topRow; r <= i.bottomRow; r++)
                      if (this.rows[r].isVisible)
                          ...
                          o = !0; u <= i.rightCol; u++)
                              ...
                              o = !1,
                              e = this.cells.getCellData(r, u, !0).toString(),
                              e = e.replace(/\t/g, ' '),
                              f += e);
                  return f
              }
                      ...
                      y = i; y <= r && y > -1 && y < o.columns.length; y++) {
                          ...
                          if (h.autoSizeMode & t.AutoSizeMode.Cells)
                              ...
                              n = c.row; n <= c.row2 && n > -1 && n < o.rows.length; n++)
                                  ...
                                  s = Math.max(s, w)) : (a = o.getCellData(n, y, !0),
                                  a != v && (v = a,
              ...
              Object.defineProperty(u.prototype, "treeIndent", {
                  ...
                  set: function (t) {
                      t != this._indent && (this._indent = n.asNumber(t, !1, !0),
              ...
              Object.defineProperty(u.prototype, "mergeManager", {
                  ...
                  set: function (i) {
                      i != this._mrgMgr && (this._mrgMgr = n.asType(i, t.MergeManager, !0),
                      this.invalidate())
                  },
                  enumerable: !0,
                  configurable: !0
              ...
              u.prototype._bindGrid = function (i) {
                  ...
                  this.deferUpdate(function () {
                      var o, s, h, c, l, u, e, f;
                      if (r._lastCount == 0 && r._cv && r._cv.items && r._cv.items.length && (i = !0),
                      o = [],
                      ...
                      o.length)
                          for (u = 0; u < r.rows.length && c < o.length; u++)
                              o.indexOf(r.rows[u].dataItem) > -1 && (r.rows[u].isSelected = !0,
                              c++);
              ...
              u.prototype._getMarqueeRect = function (i) {
                  var s = this.getMergedRange(this.cells, i.topRow, i.leftCol) || new t.CellRange(i.topRow, i.leftCol), h = this.getMergedRange(this.cells, i.bottomRow, i.rightCol) || new t.CellRange(i.bottomRow, i.rightCol), r = this.cells.getCellBoundingRect(s.topRow, s.leftCol, !0), f = this.cells.getCellBoundingRect(h.bottomRow, h.rightCol, !0), o, e, u;
                  if (this.rows.frozen) {
              ...
              u.prototype._bindColumns = function () {
                  ...
                  r && this.autoGenerateColumns)
                      for (f in r)
                          ...
                          o && !o.writable && i._setFlag(t.RowColFlags.ReadOnly, !0),
        ...
        var i = t.CellType
          , r = function () {
              ...
              r.prototype.getCellData = function (r, u, f) {
                  var s = this._rows[n.asNumber(r, !1, !0)], h, e = null, o, c;
                  if (n.isString(u) && (u = this._cols.indexOf(u),
                  u < 0))
                      throw 'Invalid column name or binding.';
                  if (h = this._cols[n.asNumber(u, !1, !0)],
              ...
              r.prototype.setCellData = function (t, r, u, f, e) {
                  ...
                  r < 0))
                      throw 'Invalid column name or binding.';
                  if (v = this._cols[n.asNumber(r, !1, !0)],
                  ...
                  this._ct == i.Cell) {
                      ...
                      o.dataType ? h = o.dataType : (p = this.getCellData(t, r, !1),
                      h = n.getType(p)),
              ...
              r.prototype._updateContent = function (t, u, f) {
                  ...
                  this._offsetY != f && (t = !1,
                  this._offsetY = f),
                  y = this._getViewRange(!1),
                  s = t && v.isTouching ? this._getViewRange(!0) : y,
                  !t || u || c.frozen || d.frozen || !this._rng.contains(y)) {
                      if (t && s.equals(this._rng) || (u = !1),
                      !t) {
                      ...
                      e = s.topRow; e <= s.bottomRow && e > -1; e++)
                          this._rowIdx.push(o),
                          o = this._renderRow(e, s, !1, u, o);
                      for (this._rowIdx.push(o),
                      e = s.topRow; e <= s.bottomRow && e > -1; e++)
                          o = this._renderRow(e, s, !0, u, o);
        ...
        var i = function () {
            ...
            return i.prototype.updateCell = function (r, u, f, e, o, s) {
                var h = r.grid, p = r.cellType, g = r.rows, nt = r.columns, y = g[u], k = nt[f], tt = u, ut = f, w = n.tryCast(y, t.GroupRow), pt = n.tryCast(y, t._NewRowTemplate), wt = k.renderWidth, bt = y.renderHeight, a = 'wj-cell', l = {
                    display: ''
                }, kt = s != !1, ht, ft, d, gt, lt, et, v, at, vt, b, yt, it, ot, rt, ii, ni, st, o, ti;
                s != !1 && e.firstElementChild && (e.childNodes.length != 1 || e.firstElementChild.type != 'checkbox') && (n.setText(e, null),
                kt = !1);
                ...
                s != !1 && (et = r.getCellData(u, f, !1),
                v = r.getCellData(u, f, !0),
                ...
                n.setText(e, v)),
                p == t.CellType.Cell && n.input && c.dataMap && c.showDropDown !== !1 && h._edtHdl._allowEditing(u, f) && (i._ddIcon || (ni = 'position:absolute;top:0px;padding:3px 6px;opacity:.25;right:0px',
                i._ddIcon = n.createElement('<div style="' + ni + '" ' + i._WJA_DROPDOWN + '><span class="wj-glyph-down"></span></div>')),
                st = i._ddIcon.cloneNode(!0),
    ...
    (function (t) {
        ...
        u = function () {
            ...
            Object.defineProperty(r.prototype, "size", {
                ...
                set: function (t) {
                    t != this._sz && (this._sz = n.asNumber(t, !0),
            ...
            r.prototype.onPropertyChanged = function () {
                this._list && (this._list._dirty = !0,
        ...
        r = function (r) {
            ...
            Object.defineProperty(u.prototype, "showDropDown", {
                ...
                set: function (t) {
                    t != this._showDropDown && (this._showDropDown = n.asBoolean(t, !0),
                    this.grid && this.grid.invalidate())
                },
                enumerable: !0,
                configurable: !0
            ...
            Object.defineProperty(u.prototype, "minWidth", {
                ...
                set: function (t) {
                    t != this._szMin && (this._szMin = n.asNumber(t, !0, !0),
                    this.onPropertyChanged())
                },
                enumerable: !0,
                configurable: !0
            ...
            Object.defineProperty(u.prototype, "maxWidth", {
                ...
                set: function (t) {
                    t != this._szMax && (this._szMax = n.asNumber(t, !0, !0),
                    this.onPropertyChanged())
                },
                enumerable: !0,
                configurable: !0
        ...
        f = function (i) {
            ...
            Object.defineProperty(r.prototype, "defaultSize", {
                ...
                set: function (t) {
                    this._szDef != t && (this._szDef = n.asNumber(t, !1, !0),
                    this._dirty = !0,
                    this._g.invalidate())
                },
                enumerable: !0,
            ...
            Object.defineProperty(r.prototype, "frozen", {
                ...
                set: function (t) {
                    t != this._frozen && (this._frozen = n.asNumber(t, !1, !0),
                    this._dirty = !0,
                    this._g.invalidate())
                },
                enumerable: !0,
          ...
          , r = function () {
              ...
              return r.prototype.getMergedRange = function (r, u, f, e) {
                  ...
                  if (s[f].allowMerging) {
                      ...
                      g = 0,
                      b = a.length - 1,
                      u >= a.frozen ? e && (h == t.CellType.Cell || h == t.CellType.RowHeader) && (l = r._getViewRange(!0),
                      g = l.topRow,
                  ...
                  if (a[u].allowMerging) {
                      ...
                      nt = 0,
                      k = s.length - 1,
                      f >= s.frozen ? e && (h == t.CellType.Cell || h == t.CellType.ColumnHeader) && (l = r._getViewRange(!0),
                      nt = l.leftCol,
                ...
                set: function (n) {
                    ...
                    if (n != this._mode) {
                        if (n == r.ListBox || this._mode == r.ListBox)
                            for (u = this._g.rows,
                            i = 0; i < u.length; i++)
                                u[i]._setFlag(t.RowColFlags.Selected, n == r.ListBox ? this._sel.containsRow(i) : !1, !1);
                        switch (n) {
                            case r.None:
                ...
                f.onSelectionChanging(c)) {
                    if (s) {
                        for (o = 0; o < f.rows.length; o++)
                            f.rows[o]._setFlag(t.RowColFlags.Selected, e.containsRow(o), !1);
    ...
    (function (t) {
        ...
        var i = function () {
            ...
            return i.prototype._keydown = function (i) {
                var r = this._g, e = r.selection, f = i.ctrlKey || i.metaKey, u = i.shiftKey, o = !0, a, l;
            ...
            i.prototype._deleteSel = function () {
                ...
                if (e.length > 0) {
                    ...
                    c > -1 && c < i.rows.length && (i.rows[c].isSelected = !0)),
                    i.childItemsPath && i.collectionView && i.collectionView.refresh(),
                    !0
                }
                return !i.isReadOnly && e.length == 0 && u.isSingleCell && (l = i._getBindingColumn(i.cells, u.row, i.columns[u.col]),
                (l.required == !1 || l.required == null && l.dataType == n.DataType.String) && i.getCellData(u.row, u.col, !0) && i.startEditing(!1, u.row, u.col)) ? (i.setCellData(u.row, u.col, '', !0),
                i.finishEditing(!0),
                i.invalidate(),
                !0) : !1
            }
                    ...
                    this._szRowCol)
                        ...
                        switch (this._htDown.cellType) {
                            case t.CellType.Cell:
                                ...
                                break;
                            case t.CellType.RowHeader:
                                (this._g.allowDragging & u.Rows) == 0 && this._mouseSelect(n, !0)
                        }
            }
            ,
    ...
    (function (t) {
        ...
        var i = function () {
                ...
                i.addEventListener(i.hostElement, 'mousedown', function (u) {
                    ...
                    if (!i._mouseHdl._szRowCol)
                        ...
                        e.cellType != t.CellType.Cell && e.cellType != t.CellType.None)
                            ...
                            f && f.type == 'checkbox' && n.hasClass(f.parentElement, 'wj-cell') && (f != r.activeEditor ? (r.startEditing(!1, e.row, e.col),
                            setTimeout(function () {
                                f = r.activeEditor;
                                f && f.type == 'checkbox' ? (f.checked = !f.checked,
                                f.focus(),
                                r.finishEditing()) : r._cancelClick = !0
                            })) : r.finishEditing()),
            ...
            i.prototype._toggleListBox = function (t) {
                ...
                !n.input || !u.dataMap || u.showDropDown === !1) ? !1 : !n.input || !this.startEditing(!0, t.row, t.col, !r) ? !1 : (this._lbx = this._createListBox(),
            ...
            i.prototype._createListBox = function () {
                ...
                i.selectedValue = t.activeEditor ? t.activeEditor.value : t.getCellData(r.row, r.col, !0),
            ...
            i.prototype._removeListBox = function () {
                this._lbx && (n.hidePopup(this._lbx.hostElement, !0),
                this._lbx.dispose(),
                this._lbx = null)
            }
            ,
    ...
    (function (t) {
        ...
        var r = function () {
            ...
            return r.prototype.updateNewRowTemplate = function () {
                ...
                i.push(this._nrt)),
                this._nrt && this._nrt._setFlag(t.RowColFlags.ParentCollapsed, !1))
            }
            ,
    ...
    (function (t) {
        ...
        var i = function () {
            ...
            t.prototype._compositionstart = function () {
                ...
                t.startEditing(!1, i.row, i.col, !1))) {
            ...
            t.prototype._updateImeFocus = function () {
                ...
                this._enableIme() ? (n.disabled = !1,
                n.select()) : n.disabled || (n.disabled = !0,
